    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fromSymbol?.let {
            viewModel.getDetailInfo(fromSymbol).observe(this, Observer {
                Picasso.get().load(it.getFullImageUrl()).into(imageViewCoinDetail)
                ...
                textViewUpdate.text = String.format(resources.getString(R.string.detail_last_update), it.getFormatedTime())
            })
        }
    }
